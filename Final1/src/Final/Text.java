...
public class Text {
	...
	public static void text2() {
		...
		System.out.println("Every year in October, skeletons arise from their graves to delcare war against insolent human beings. \nThose who do not have .:Rest In Piece:. written"
				+ " on their grave are automatically drafted into the \nskeleton war. It's finally October, and your skeletal body has arrisen from the grave. It's time to \nshow "
				+ "those foolish humans whose boss of this realm.");
